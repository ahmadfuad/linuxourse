...
<div class="large-12 columns">
	<dl class="tabs" data-tab>
		...
		<dd style="width:33.33%"><a ng-click="getMyTest('closed')" href="#courseList">Clossed Test (<?php echo $totalclosedtest;?>)</a></dd>
	</dl>
</div>
</center>
</section>
						  ...
						  <div class="row">
						    <div class="small-12 columns">
						      ...
						      <div class="row">
						        ...
						        <div class="small-9 columns">
						          <input min="<?php echo date('Y-m-d H:i:s');?>" type="datetime-local" id="open" ng-model="new.testOpen">
						        </div>
						      </div>
						       <div class="row">
						        <div class="small-2 columns">
						        ...
						        <div class="small-9 columns">
						          <input min="<?php echo date('Y-m-d H:i:s');?>" type="datetime-local" id="close" ng-model="new.testClose">
						        </div>
						      </div>
						      <div class="row">
						        <div class="small-2 columns">
